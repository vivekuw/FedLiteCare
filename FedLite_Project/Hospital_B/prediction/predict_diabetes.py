"""Hospital B local diabetes prediction entrypoint."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run Hospital B diabetes predictions from a CSV file.")
    parser.add_argument(
        "--config",
        type=Path,
        default=DEFAULT_CONFIG_PATH,
        help="Path to the Hospital B config file.",
    )
    parser.add_argument(
        "--input",
        type=Path,
