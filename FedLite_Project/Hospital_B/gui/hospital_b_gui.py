"""Tkinter GUI launcher for Hospital B."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Launch the Hospital B FedLiteCare desktop GUI.")
    parser.add_argument(
        "--config",
        type=Path,
        default=DEFAULT_CONFIG_PATH,
        help="Optional Hospital B config path.",
    )
