"""Tkinter GUI launcher for Hospital A."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Launch the Hospital A FedLiteCare desktop GUI.")
    parser.add_argument(
        "--config",
        type=Path,
        default=DEFAULT_CONFIG_PATH,
        help="Optional Hospital A config path.",
    )
