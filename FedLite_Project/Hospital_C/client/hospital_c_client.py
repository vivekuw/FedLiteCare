"""Convenience CLI wrapper for Hospital C local ML workflows."""
...
from FedLite_Project.Hospital_C.local_training.local_trainer import (
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Hospital C local training and prediction commands.")
